            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-12 col-md-10 col-lg-8 col-xl-6 text-center">
                        {/* Preheading */}
                        <h6 className="heading-xxs mb-3 text-gray-400">{t(`New Collection`)}

                        </h6>
                        {/* Heading */}
                        <h2 className="mb-4">{t(`Best Picks 2019`)}</h2>
                        {/* Subheading */}
                        <p className="mb-10 text-gray-500">{t(`Appear, dry there darkness they're seas, dry waters thing fly midst. Beast, above fly brought Very green.`)}
