                    ...
                    <div className="col-12 col-lg-10 col-xl-8">
                        ...
                        <ul className="list-group list-group-flush-x mb-9" id="faqCollapseParentOne">
                            <li className="list-group-item">
                                {/* Toggle */}
                                <a className="dropdown-toggle d-block font-size-lg font-weight-bold text-reset" data-toggle="collapse" href="#faqCollapseOne" aria-expanded="true">
                                    1. Bring of had which their whose you're it own?
                  </a>
                                {/* Collapse */}
                                <div className="collapse show" id="faqCollapseOne" data-parent="#faqCollapseParentOne" style={{}}>
                                    <div className="mt-5">
